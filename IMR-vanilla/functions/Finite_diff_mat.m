...
%                 Diff_Matrix(1,1) = 1-deltaY/yk(1) ;
%                 Diff_Matrix(1,2) = -2 ;
%                 Diff_Matrix(1,3) = 1+deltaY/yk(3) ;
%                 
%                 Diff_Matrix(end,end-2) = 1-deltaY/yk(N-2) ;
%                 Diff_Matrix(end,end-1) = -2 ;
%                 Diff_Matrix(end,end) =  1+deltaY/yk(N) ;
                Diff_Matrix(1,1)= -2*N^2; Diff_Matrix(1,2) = 2*N^2;
